...
theme1 = new Image();
theme1.src = require("@/assets/img/og-theme.png");
theme2 = new Image();
theme2.src = require("@/assets/img/og-theme-2.png");

frame = 0;
degree = Math.PI / 180;
SFX_SCORE.src = require("@/assets/audio/sfx_point.wav");
SFX_FLAP.src = require("@/assets/audio/sfx_wing.wav");
SFX_COLLISION.src = require("@/assets/audio/sfx_hit.wav");
SFX_FALL.src = require("@/assets/audio/sfx_die.wav");
SFX_SWOOSH.src = require("@/assets/audio/sfx_swooshing.wav");
